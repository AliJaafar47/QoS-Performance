...
from qos_performance import combiners
from qos_performance.util import classname, long_substr, format_date, diff_parts, \
...
def new(settings, plotter=None, in_worker=False, **kwargs):
    try:
        ...
        #added by me for unknown reason 
        print("settings new plotters",settings)
        settings.GUI = True
        settings.GUI_NO_DEFER = False
        return plotter(
